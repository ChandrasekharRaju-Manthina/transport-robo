...
public class VehicleRoutingSolverManager implements Serializable {
    ...
    private VehicleRoutingSolverManager() {
    	
    }
    
    private static VehicleRoutingSolverManager INSTANCE;
    
    public static synchronized VehicleRoutingSolverManager getInstance() {
    	if(INSTANCE == null) {
    		INSTANCE = new VehicleRoutingSolverManager();
    		INSTANCE.init();
    	}
    	return INSTANCE;
    }
