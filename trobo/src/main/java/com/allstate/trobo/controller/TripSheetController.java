...
public class TripSheetController {
	...
	public List<PickupPoint> getPickupPointDetails() {
		return tripSheetService.getPickupPointDetails();
	}
	...
	public TripSheet getPickupPointDetails11(@RequestBody TripSheet tripSheet) {
	...
	public JsonVehicleRoutingSolution genrateTripSheet(@RequestBody TripSheet tripSheet) {
		  VehicleRoutingSolution solution = tripSheetService.generateTripSheet(tripSheet);
