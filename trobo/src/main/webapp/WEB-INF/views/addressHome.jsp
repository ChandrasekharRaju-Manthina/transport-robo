...
<div class="row">
	<div class="col-lg-12">
		...
		<ol class="breadcrumb" id="addAddressLink" style="display: none;">
            <li>
                <i class="fa fa-dashboard"></i>  <a href="#" name="addressMenu" onclick="resetToAdd('addressForm')">Add address</a>
            </li>
        </ol>
	</div>
</div>
